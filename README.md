...
it can be finicky to make sure gradle pulls the latest version based on that tag. In those cases it's better to set `zenlibVersion` to the most recent commit hash.
